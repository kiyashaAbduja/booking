                ...
                <Form className="p-6 bg-white rounded-lg shadow-lg w-96 relative">
                        ...
                        <div className="flex items-center">
                            ...
                            <div ref={dateContainerRef} className="flex space-x-2 overflow-x-hidden">
                                {['29 Oct', '30 Oct', '31 Oct', '1 Nov', '2 Nov', "3 Nov", "4 Nov", "5 Nov", "6 Nov", "7 Nov"].map((date) => (
                                    <button
                                        key={date}
                                        className={`p-2 border border-gray-300 rounded ${values.date === date ? 'bg-blue-500 text-white' : ''}`}
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex space-x-2">
                            {['Unpaid', 'Partly Paid', 'Already Paid'].map((status) => (
                                <label key={status} className="flex items-center space-x-2">
                                    <Field type="radio" name="amount" value={status} />
                                    <span>{status}</span>
                                </label>
                            ))}
                        </div>
