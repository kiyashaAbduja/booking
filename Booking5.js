                                    ...
                                    <>
                                        ...
                                        {availableTimes?.length > 0 ? availableTimes.map((time) => (
                                            <button
                                                ...
                                                type="button"
                                                onClick={() => setFieldValue('time', time)}
                                                className={`p-2 ${values.time === time ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'} rounded m-1 whitespace-nowrap`}>
                                                {time}
                                            </button>
                                        )) : (
                                            <p className="p-2">No times available</p>
                                        )
                                        }
